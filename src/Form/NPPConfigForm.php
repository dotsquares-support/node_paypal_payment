...
class NPPConfigForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['onoff']['npp_enabled'] = [
      ...
      '#description' => $this->t('To enable paypal payment for you content you must turn it on here first.'),
    ];
    ...
    $form['onoff']['npp_content_types'] = [
      ...
      '#description' => $this->t('Allow paypal payment for selected content types'),
    ];
    ...
    $form['payment_options']['npp_email'] = [
      ...
      '#description' => $this->t('The paypal email address to recieve payments.'),
    ];
